...
public class Main2Activity extends AppCompatActivity
    ...
    private static final String TAG_TRACE = MainActivity.class.getSimpleName()+".TRACE";
    ...
    private boolean mBundelUitGelezen =false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.d(TAG_TRACE, "OnCreate, spel wordt gecreeerd");
...
//        });
        ...
        mDoeGokButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Code codeVoorresultaat = new Code(new Pion(){{setKleur(Kleur.geel);}}
    ...
    protected void onPause() {
        super.onPause();
        Log.d(TAG_TRACE, "onPause");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.d(TAG_TRACE, "onDestroy");
        mActivityDestroyed = true;
    }

    @Override
    protected void onResume() {
        Log.d(TAG_TRACE, "onResume, spel wordt hersteld");
        Log.i(TAG, "code:" + spel.getCode().toString());
...
//        }
        if (spelData != null && mBundelUitGelezen ){
            mBundelUitGelezen =false;
...
//                        doeGokButton.setText("Guess");
    ...
    protected void onSaveInstanceState(Bundle outState) {
        Log.d(TAG_TRACE, "onSaveInstanceState, speldata wordt in  bundel gestopt");
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        Log.d(TAG_TRACE, "onRestoreInstanceState, speldata wordt uit bundel gehaald");
